...
export function LoginScreen() {
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    // Lógica para e-mail/senha ou OTP pode ser expandida aqui conforme necessário
    toast.info("Funcionalidade de e-mail em implementação. Use o Google.")
      ...
      <Card className="w-full max-w-md border-none bg-zinc-900/90 text-white backdrop-blur-md">
        <CardHeader className="text-center space-y-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-zinc-400">Digite seu endereço de e-mail</p>
          </div>
        </CardHeader>
